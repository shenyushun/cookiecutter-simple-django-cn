...
# ({{ cookiecutter.project_slug }}/config/settings/common.py - 3 = {{ cookiecutter.project_slug }}/)
...
DATABASES = {
    ...
    'default': env.db('DATABASE_URL', default='sqlite:////tmp/{{cookiecutter.project_slug}}.sqlite3'),
}
